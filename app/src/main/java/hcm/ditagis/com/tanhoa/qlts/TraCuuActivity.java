...
private List<String> mLstFeatureType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(hcm.ditagis.com.tanhoa.qlts.R.layout.activity_tra_cuu);

        mServiceFeatureTable = new ServiceFeatureTable(getResources().getString(hcm.ditagis.com.tanhoa.qlts.R.string.service_feature_table));
        ...
        View layout = findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.layout_tracuu_include);
        ListView lstViewInfo = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.lstView_alertdialog_info);
        ...
        if (parent.getItemAtPosition(position) instanceof FeatureViewMoreInfoAdapter.Item) {
            ...
            if (item.isEdit()) {
                ...
                final android.widget.LinearLayout layout = (android.widget.LinearLayout) this.getLayoutInflater().
                        inflate(hcm.ditagis.com.tanhoa.qlts.R.layout.layout_dialog_update_feature_listview, null);
                builder.setView(layout);
                final android.widget.FrameLayout layoutTextView = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.layout_edit_viewmoreinfo_TextView);
                final android.widget.TextView textView = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.txt_edit_viewmoreinfo);
//                final Button button = layout.findViewById(R.id.);
                final android.widget.LinearLayout layoutEditText = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.layout_edit_viewmoreinfo_Editext);
                final EditText editText = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.etxt_edit_viewmoreinfo);
                final android.widget.LinearLayout layoutSpin = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.layout_edit_viewmoreinfo_Spinner);
                final Spinner spin = layout.findViewById(hcm.ditagis.com.tanhoa.qlts.R.id.spin_edit_viewmoreinfo);
